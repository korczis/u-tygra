...
check_file "$ADMIN" 'adminApp' "has adminApp() binding"
check_file "$ADMIN" 'signIn' "has signIn button"
check_file "$ADMIN" 'admin-panel-events' "has events tab panel"
check_file "$ADMIN" 'admin-panel-food' "has food tab panel"
check_file "$ADMIN" 'admin-panel-photos' "has photos tab panel"
check_file "$ADMIN" 'admin-panel-settings' "has settings tab panel"
check_file "$ADMIN" 'saveEvent' "has saveEvent handler"
check_file "$ADMIN" 'saveFood' "has saveFood handler"
check_file "$ADMIN" 'exportData' "has exportData handler"
check_file "$ADMIN" 'saveAnnouncement' "has saveAnnouncement handler"
check_file "$ADMIN" 'Přihlásit' "has Czech diacritics (Přihlásit)"
check_file "$ADMIN" 'Uložit' "has Czech diacritics (Uložit)"
check_file "$ADMIN" 'Jídelní' "has Czech diacritics (Jídelní)"
check_file "$ADMIN" 'Nastavení' "has Czech diacritics (Nastavení)"
check_file "$ADMIN" 'Žádné' "has Czech diacritics (Žádné)"
