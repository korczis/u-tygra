+++
title = "Chmel"
description = "Klíčová surovina pivovarnictví. Dodává pivu hořkost, aróma a konzervační vlastnosti."
[extra]
en = "Hops"
category = "suroviny"
...
| Odrůda | Aróma | Alfa | Použití |
|--------|-------|------|---------|
| **Žatecký (Saaz)** | Koření, bylinky, jemné | 2,5–5 % | Pilsner, český ležák |
| **Kazbek** | Citrusy, limeta | 5–8 % | Craft IPA, APA |
| **Sládek** | Koření, květiny | 4–8 % | Ležáky |
| **Premiant** | Jemné, klasické | 7–10 % | Hořké chmelení |
| **Agnus** | Intenzivní, pryskyřice | 9–14 % | Hořké chmelení |

## Světové odrůdy

| Odrůda | Původ | Aróma |
|--------|-------|-------|
| **Citra** | USA | Grapefruit, mango, lichi |
| **Mosaic** | USA | Borůvky, tropické ovoce |
| **Cascade** | USA | Grapefruit, květiny |
| **Simcoe** | USA | Jehličí, marakuja |
| **Nelson Sauvin** | Nový Zéland | Bílé víno, angrešt |
| **Hallertau Mittelfrüh** | Německo | Koření, květiny |
| **East Kent Goldings** | Anglie | Medové, květinové |

## Česká republika a chmel
...
- **Celé šištice**: Tradiční, ale velký objem
- **Pelety (Type 90)**: Mleté a lisované, nejběžnější
- **Lupulinový prášek (Cryo Hops)**: Koncentrovaný lupulin, intenzivní aróma
- **Chmelový extrakt**: Standardizovaný, pro velkovýrobu
